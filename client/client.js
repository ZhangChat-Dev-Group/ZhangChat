...
*/
	...
	const url = ( document.domain === 'chat.zhangsoft.cf' || document.domain === 'chat.zhangsoft.eu.org' ) ? protocol + '//chat.zhangsoft.cf/ws/zhc/chat' : `${protocol}//${document.domain}${wsPath}`
